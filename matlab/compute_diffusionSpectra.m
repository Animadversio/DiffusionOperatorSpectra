...
figdir = "/Users/binxuwang/Library/CloudStorage/OneDrive-HarvardUniversity/DiffusionSpectralTheory/Simulation/TDDiffSpectra_"+suffix;
mkdir(figdir)
...
% HDiff = 1 / dx^2 * DDLpls - 1/ dx * (Dx * I .* Ux + Dy * I .* Uy);
% HDiff = 1 / dx^2 * DDLpls - 1/ dx * (Dx .* Ux + Dy .* Uy); % spectrum of this has interesting geometry
HDiff = DDLpls / dx^2 - 1 / dx * (Dx * Ux + Dy * Uy) .* I - (Ux .* Dx + Uy .* Dy) / dx; % true form. 
